...
export default function SidebarMenu() {
  return (
    <Menu as="div" className="relative inline-block text-left">
      ...
      <span className="text-xl"><HiMenu /></span>
      </MenuButton>
      <Transition
        as={Fragment}
...
const CustomMenuItem = ({ item }) => {
  ...
  return (
    <MenuItem>
    <div className="group flex items-center px-4 py-2 text-sm cursor-pointer rounded-md data-[focus]:bg-gray-100 data-[hover]:bg-gray-100"
